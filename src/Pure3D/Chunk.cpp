...
std::ostream& operator<< (std::ostream& os, ChunkType chunktype)
{
	...
	case ChunkType::LensFlareGroup: return os << "LensFlareGroup";
	...
	case ChunkType::TextBible: return os << "TextBible";
	...
	case ChunkType::ImageFont: return os << "ImageFont";
	...
	case ChunkType::VertexAnimKey: return os << "VertexAnimKey";
	...
	case ChunkType::StatePropData: return os << "StatePropData";
