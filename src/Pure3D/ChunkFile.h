...
typedef std::uint32_t ChunkType;
enum class ChunkTypeID : uint32_t
{
	Camera = 0x2200,
	LightGroup = 0x2380,
	Skeleton = 0x4500,
...
public:
	 ...
	 * @return The new chunk type id.
	 */
	ChunkType BeginChunk(ChunkType chunkType);
