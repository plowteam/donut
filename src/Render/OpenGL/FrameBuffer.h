...
namespace Donut::GL
{
	...
	public:
		...
		public:
			...
			void EnableDepthBuffer(bool depthBuffer = true, bool depthBufferAsTexture = true) { _depthBuffer = depthBuffer; _depthBufferAsTexture = depthBufferAsTexture; }
			...
			inline void SetWrap(GLenum wrapS, GLenum wrapT) { SetWrapS(wrapS); SetWrapT(wrapT); }
